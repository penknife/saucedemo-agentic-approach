...
## Project Fixture Convention (saucedemo-agentic-approach)

When writing or updating Playwright spec files in this repository:

- Import test API from fixtures, never directly from `@playwright/test` in spec files.
